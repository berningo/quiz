...
## Quiz Data
As long as the quiz data is not residing in a database, you have to edit the Typescript file that contains the quiz data. The path is `src/lib/server/data.ts` (the directory `server` must be created).
